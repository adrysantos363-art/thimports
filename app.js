...
function getFirebaseConfig(){
  const fallback = window.TH_FIREBASE_CONFIG || {};
  return {
    apiKey:$("fbApiKey").value.trim() || fallback.apiKey || "",
    authDomain:$("fbAuthDomain").value.trim() || fallback.authDomain || "",
    projectId:$("fbProjectId").value.trim() || fallback.projectId || "",
    storageBucket:$("fbStorageBucket").value.trim() || fallback.storageBucket || "",
    messagingSenderId:$("fbMessagingSenderId").value.trim() || fallback.messagingSenderId || "",
    appId:$("fbAppId").value.trim() || fallback.appId || ""
  };
}
